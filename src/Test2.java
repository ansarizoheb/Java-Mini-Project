...
class Test2
{
    ...
    public void addFaculty()
    {
        try{
            ...
            Connection
                    ...
                    "jdbc:mysql://localhost:3306/faculties","root","");
            System.out.println("Connecting database...");
            Scanner sc=new Scanner(System.in);
            PreparedStatement stmt=con.prepareStatement("insert into facultiestable values(?,?,?)");
    ...
    public void displayFaculty()
    {
        try{
            Class.forName("com.mysql.jdbc.Driver");
            Connection
                    con=DriverManager.getConnection("jdbc:mysql://localhost:3306/faculties","root","");
            Statement stmt=con.createStatement();
            ResultSet rs=stmt.executeQuery("select * from facultiestable");
            while(rs.next())
    ...
    public void deleteFaculty()
    {
        try{
            ...
            Connection
                    con=DriverManager.getConnection("jdbc:mysql://localhost:3306/faculties","root","");
            Scanner sc=new Scanner(System.in);
            PreparedStatement stmt=con.prepareStatement("delete from facultiestable where rollno=?");
